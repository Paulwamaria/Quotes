...
export class QuotesComponent implements OnInit {
  ...
  quotes: Quote[] = [
    new Quote( 1, `Nothing in this world can take the place of persistence. 
    ...
    new Quote( 2, `Programming is like sex,
    ...
    new Quote( 3, `Your work is going to fill a large part of
    ...
    new Quote( 4, `Sometimes the worst place you can be at is in your own head.`,
  ...
  voteUp(touching: boolean, index: number): void {
    if (touching) {
  ...
  toggleQuotes(index: number): void {
    this.quotes[index].showDescription = !this.quotes[index].showDescription;
  }

  removeQuote(untouching: boolean, index: number): void {
    if ( untouching) {
